        ...
        <template #header>
            <div class="flex items-center justify-between">
                ...
                <Link
                    ...
                    class="inline-flex items-center rounded-md border border-gray-300 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-widest text-gray-700 shadow-sm transition hover:bg-gray-50 focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
                >
                    Back to Students
                </Link>
            </div>
                    ...
                    <form @submit.prevent="submit" class="p-6">
                        ...
                        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            <div>
                                ...
                                <TextInput id="full_name" v-model="form.full_name" type="text" class="mt-1 block w-full" required autofocus />
                        ...
                        <div class="mt-8 flex items-center gap-4">
                            <PrimaryButton :disabled="form.processing">Save Student</PrimaryButton>
