            ...
            <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div class="mb-8">
                    <p class="max-w-2xl text-sm text-gray-500">
                        Browse available teaching modules. Subscribe to add them to your dashboard; unsubscribe to remove.
                    </p>
                </div>
                ...
                <div v-else-if="error" class="rounded-lg border border-red-200 bg-red-50 p-6">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            ...
                            <button @click="fetchModules" class="mt-3 text-sm font-medium text-red-600 underline hover:text-red-800">
                                Try again
                            </button>
                        </div>
                    </div>
                ...
                <!-- Empty -->
                <div v-else-if="modules.length === 0" class="flex flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 py-16">
                    ...
                    >
                        ...
                        <div class="flex flex-1 flex-col p-5">
                            ...
                            <div class="mt-4 flex items-center justify-between">
                                ...
                                >
                                    <svg v-if="subscribing === mod.slug" class="h-4 w-4 animate-spin" fill="none" viewBox="0 0 24 24">
                                        <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" />
                                        <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4z" />
                                    </svg>
                                    {{ subscribing === mod.slug ? 'Processing...' : (mod.is_subscribed ? 'Unsubscribe' : 'Subscribe') }}
                                </button>
                            </div>
                        </div>
                    </div>
